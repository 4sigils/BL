...
local _libOk, _libErr = pcall(function()
    GalaxLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/4sigils/ThoseWhoKnow/refs/heads/main/BlahBlah"))() or GalaxLib
end)
...
_G.AutoRetry_Enabled     = false
_G.AutoRetryVoid_Enabled = false
_G.VampireVoid_Enabled   = false
...
-- Boss/method state — declared early so all lobby/fight functions can reference them
...
-- RaidTab created early so sections can be added after
...
-- Shared Jotaro lobby TP — called by both Auto Raid and Auto Void when PlaceId == 14890802310
